...
const P: Record<IconName, ReactNode> = {
  ...
  "wifi-off": (
    <>
      ...
      <path d="M2 2l20 20" />
      <path d="M5 12.858a10 10 0 0 1 1.172-1.163" />
...
export function Logo({ size = 28, className = "" }: { size?: number; className?: string }) {
  return (
    <span
      className={`flex shrink-0 items-center justify-center rounded-xl bg-blue-600 text-white ${className}`}
      style={{ width: size, height: size }}
    >
      <Icon name="wifi" size={Math.round(size * 0.55)} />
    </span>
  );
}